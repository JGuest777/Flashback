var importedFlashCardDataFile = [
	...
	},
	{
		...
		back: {
			...
			answer: 'Jordan Walke',
			description:
				'At the time, he was working on Facebook Ads. He later moved to Product Infrastructure to focus on React full-time.'
		}
	},
	{
		front: {
		...
		back: {
			...
			answer: 'News Feed',
			description:
				"The first version of Instagram's feed was also built using React. They were the first 'external' user of React."
		}
	},
	{
		front: {
		...
		back: {
			...
			answer: 'open-sourced',
			description:
				'React is maintained by Instagram, Facebook, and a community of individual developers and corporations.'
		}
	},
	{
		front: {
		...
		back: {
			...
			answer: 'components',
			description:
				'Components accept inputs called props and return outputs describing what should appear on the screen.'
		}
	},
	{
		front: {
			...
			hint:
				'Whenever this changes, React calls the render method and applies any changes to the HTML of the page.'
		},
		back: {
